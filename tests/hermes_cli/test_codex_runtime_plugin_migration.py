...
class TestHermesProfileEnvironment:
    @pytest.mark.parametrize("home", [None, "/Users/alice/.hermes", "/tmp/pytest-of-alice/profile"])
    def test_profile_home_is_inherited_at_launch(self, monkeypatch, home):
        if home is None:
