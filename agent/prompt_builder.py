...
KANBAN_GUIDANCE = (
    ...
    "5. **Honour the card review requirement first.** When review_required is true, "
    "the developer must request same-card review and a separate reviewer execution "
    "must accept the submitted state before completion, even if child cards exist. "
    "For other cards, finish with the review model encoded by the task graph. Always "
